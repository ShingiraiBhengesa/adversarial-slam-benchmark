...
#   bash scripts/run_orbslam3_stereo_kitti.sh <KITTI_SEQUENCE_DIR> <KITTI_SETTINGS_YAML>
#
# Example:
#   bash scripts/run_orbslam3_stereo_kitti.sh data/kitti/dataset/sequences/00 systems/ORB_SLAM3/Examples/Stereo/KITTI00-02.yaml
